...
if __name__ == '__main__':
    ...
    suite.addTests(unittest.TestLoader().loadTestsFromName('test_myfun.TestMyFun'))
    suite.addTests(unittest.TestLoader().loadTestsFromNames(['test_myfun.TestMyFun']))  # loadTestsFromNames()，类似，传入列表

    # loadTestsFromTestCase()，传入TestCase
    suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestMyFun))
